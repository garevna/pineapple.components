<template>
<div>
<svg id="pineapple-logo" class="defs-only" xmlns="http://www.w3.org/2000/svg">
<g>
<rect x="-35.3" y="-31.1" class="st0" width="566.9" height="191.3"/>
<linearGradient id="logo_gradient" gradientUnits="userSpaceOnUse" x1="2.7365" y1="64.5895" x2="111.1852" y2="64.5895">
...
<figure>
  <div>
    <svg viewBox="0 0 494.3 124.7" width="128" height="40">
      <use xlink:href="#pineapple-logo"/>
    </svg>
  </div>
</figure>
</div>
...
<style scoped>
#pineapple-logo { enable-background:new 0 0 494.3 124.7; }
.st0 { fill:none; }
