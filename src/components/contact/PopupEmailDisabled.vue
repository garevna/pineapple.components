<template>
  <v-row justify="center">
      <v-dialog v-model="opened" persistent max-width="290">
        <v-card class="pa-6" style="overflow: hidden;">
          ...
          <v-card-text class="text-center">
            <v-btn class="submit-button" @click="$emit('update:opened', false)">CLOSE</v-btn>
          </v-card-text>
        </v-card>
      </v-dialog>
    </v-row>
...
import { VRow, VDialog, VCard, VCardText, VBtn } from 'vuetify/lib'
